...
const FlorcastMap = forwardRef<HTMLElement, FlorcastMapProps>(
  ({ className }, ref) => {
    return (
          ...
          <div className="flex-1 relative z-10">
            ...
            <div className="about-animate space-y-4">
              <p className="text-black text-balance text-left text-lg leading-relaxed">
                ...
                accessible tool that benefits communities, farmers, beekeepers,
                and scientist, promoting a greater understanding of the
                importance of flowers and their environmental impact.
              </p>
