        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-green-100 mb-6 leading-relaxed">
              Predicción avanzada del florecimiento usando inteligencia
              artificial y datos meteorológicos para optimizar la agricultura y
              jardinería.
            </p>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              <a
                href="#"
                className="bg-green-700/50 hover:bg-green-600 p-3 rounded-full transition-all duration-300 hover:scale-110 group"
              >
                <SiInstagram
                  size={20}
                  className="text-pink-300 group-hover:text-pink-200"
                />
              </a>

              <a
                href="#"
                className="bg-green-700/50 hover:bg-gray-800 p-3 rounded-full transition-all duration-300 hover:scale-110 group"
              >
                <SiGithub
                  size={20}
                  className="text-gray-300 group-hover:text-gray-200"
                />
              </a>
            </div>
